...
(function () {
  ...
  const ICONOS = {
    ...
    video: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h9a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H4Zm0 2h9a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1Z"/><path d="M22.4 6.55a1 1 0 0 0-1.02.05l-3.5 2.4A1 1 0 0 0 17.5 9.8v4.4a1 1 0 0 0 .38.8l3.5 2.4A1 1 0 0 0 23 16.6V7.4a1 1 0 0 0-.6-.85Zm-1.4 3.16v4.58l-1.5-1.03v-2.52l1.5-1.03Z"/></svg>',

    // Libro abierto: la bitácora de operaciones.
    bitacora: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5.4c-1.6-1.1-3.6-1.7-5.6-1.7-1 0-2 .15-2.94.44A1 1 0 0 0 2.8 5.1v12.3a1 1 0 0 0 1.3.95c.75-.24 1.54-.36 2.3-.36 1.8 0 3.55.6 4.9 1.66a1.1 1.1 0 0 0 1.4 0c1.35-1.06 3.1-1.66 4.9-1.66.76 0 1.55.12 2.3.36a1 1 0 0 0 1.3-.95V5.1a1 1 0 0 0-.66-.96c-.94-.29-1.94-.44-2.94-.44-2 0-4 .6-5.6 1.7Zm-1 12.03c-1.36-.7-2.9-1.08-4.6-1.08-.53 0-1.06.04-1.6.12V5.87c.52-.11 1.06-.17 1.6-.17 1.7 0 3.3.44 4.6 1.24v10.49Zm2 0V6.94c1.3-.8 2.9-1.24 4.6-1.24.54 0 1.08.06 1.6.17v10.6c-.54-.08-1.07-.12-1.6-.12-1.7 0-3.24.38-4.6 1.08Z"/></svg>',
    ...
    // Flecha hacia una bandeja: descargar un archivo (el cronograma en imagen).
    descarga: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3a1 1 0 0 1 1 1v9.59l2.3-2.3a1 1 0 1 1 1.4 1.42l-4 4a1 1 0 0 1-1.4 0l-4-4a1 1 0 1 1 1.4-1.42l2.3 2.3V4a1 1 0 0 1 1-1Z"/><path d="M4 15a1 1 0 0 1 1 1v2a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2a1 1 0 1 1 2 0v2a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3v-2a1 1 0 0 1 1-1Z"/></svg>',
  };
